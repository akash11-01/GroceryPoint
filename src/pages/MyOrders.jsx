    ...
    return (
        <div className="mt-16 pb-16">
            <div className='flex  flex-col items-end w-max mb-8'>
                <p className='text-2xl font-medium uppercase'>My orderd</p>
                <div className="w-16 h-0.5 bg-[#4fbf8b] rounded-full"></div>
            </div>
            {
                myOrders.map((order, index) => (
                    <div key={index} className="border border-gray-300 rounded-lg mb-10 p-4
                    py-5 max-w-4xl">
                            ...
                            order.items.map((item, index) => (
                                ...
                                w-full max-w-4xl `}>
                                    <div className="flex items-center mb-4 md:mb-0">
                                        <div className="bg-[#4fbf8b] p-4 rounded-lg">
