    ...
    <div className="flex flex-col md:flex-row mt-16">
      <div className="flex-1 max-w-4xl">
        ...
        {cartArray.length > 0 ? (
          ...
          <p className="text-gray-500 py-6">Your cart is empty.</p>
        )}
          ...
          {currentUser ? (
            ...
            <div className="mt-2">
              <p className="text-gray-500 text-sm">
                Please login or register to add address and place your order.
              </p>
              <button
                onClick={() => dispatch(showUserLoginForm(true))}
                className="mt-3 text-[#4fbf8b] hover:underline cursor-pointer"
              >
                Login / Register
              </button>
            </div>
